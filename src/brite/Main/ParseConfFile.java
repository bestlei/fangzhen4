...
final public class ParseConfFile {
	...
	//double bwMax = (Double)params.get("BWMax").doubleValue();
	//double bwMin = (Double)params.get("BWMin").doubleValue();
	//double  alpha  = (Double)params.get("alpha").doubleValue();
	//double beta =  (Double)params.get("beta").doubleValue();
