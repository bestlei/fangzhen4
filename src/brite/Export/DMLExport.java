...
public class DMLExport {
  ...
  public void export() {
	...
	FileModel f = new FileModel(brite.Import.ImportConstants.BRITE_FORMAT, briteFile, ModelConstants.RT_FILE); 
	...
	format = ModelConstants.AS_FILE;
      ...
      FileModel f = new FileModel(brite.Import.ImportConstants.BRITE_FORMAT, briteFile, format); 
      Topology t = new Topology(f);
