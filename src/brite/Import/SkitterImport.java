...
public class SkitterImport {
  ...
  public void convert(String briteFile) {
    ...
    int maxValue = 1;
    String typeOfFile = "";
    BriteExport be = new BriteExport(t, new File(briteFile),noUseFile, minValue ,maxValue,typeOfFile);
    be.export();
  }
  ...
  public static void main(String args[]) throws Exception {
    ...
    int maxValue = 1;
    String typeOfFile = "";
    BriteExport be = new BriteExport(t, new File(fileToWrite),noUseFile,minValue,maxValue,typeOfFile);
    be.export();
